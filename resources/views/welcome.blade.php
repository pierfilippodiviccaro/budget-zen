<x-app-layout>
    ...
    <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; padding: 60px 20px 40px;">
        ...
        <div style="display:flex; gap:12px; flex-wrap:wrap; justify-content:center;">
            <a href="{{ route('register') }}" style="display:inline-flex; align-items:center; gap:8px; background:#0C2D6B; color:#fff; padding:12px 24px; border-radius:9px; font-size:14px; font-weight:500; text-decoration:none; border:1px solid transparent; transition:background 0.15s;">
                <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                    <path stroke-linecap="round" d="M12 4.5v15m7.5-7.5h-15"/>
                </svg>
                Inizia gratis
            </a>
            <a href="{{ route('login') }}" style="display:inline-flex; align-items:center; gap:8px; background:transparent; color:#185FA5; padding:12px 24px; border-radius:9px; font-size:14px; font-weight:500; text-decoration:none; border:1px solid #dde6f5; transition:background 0.15s;">
                Accedi
    ...
    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(200px, 1fr)); gap:14px; margin-bottom:32px;">
        ...
        <div class="bz-card" style="border-top:3px solid #185FA5;">
            <div style="width:38px; height:38px; border-radius:9px; background:#E6F1FB; display:flex; align-items:center; justify-content:center; margin-bottom:14px;">
                <svg width="18" height="18" fill="none" stroke="#185FA5" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <p style="font-size:13px; color:#5a7aaa; line-height:1.6;">Registra entrate e uscite in pochi secondi, con categorie personalizzate.</p>
        </div>

        <div class="bz-card" style="border-top:3px solid #1D9E75;">
            <div style="width:38px; height:38px; border-radius:9px; background:#E1F5EE; display:flex; align-items:center; justify-content:center; margin-bottom:14px;">
                <svg width="18" height="18" fill="none" stroke="#1D9E75" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <p style="font-size:14px; font-weight:500; color:#0C2D6B; margin-bottom:6px;">Budget mensili</p>
            <p style="font-size:13px; color:#5a7aaa; line-height:1.6;">Imposta un tetto di spesa per ogni categoria e monitora l'avanzamento.</p>
        </div>

        <div class="bz-card" style="border-top:3px solid #378ADD;">
            <div style="width:38px; height:38px; border-radius:9px; background:#E6F1FB; display:flex; align-items:center; justify-content:center; margin-bottom:14px;">
                <svg width="18" height="18" fill="none" stroke="#378ADD" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <p style="font-size:14px; font-weight:500; color:#0C2D6B; margin-bottom:6px;">Report chiari</p>
            <p style="font-size:13px; color:#5a7aaa; line-height:1.6;">Grafici e riepiloghi mensili per capire dove vanno i tuoi soldi.</p>
        </div>

        <div class="bz-card" style="border-top:3px solid #BA7517;">
            <div style="width:38px; height:38px; border-radius:9px; background:#FAEEDA; display:flex; align-items:center; justify-content:center; margin-bottom:14px;">
                <svg width="18" height="18" fill="none" stroke="#BA7517" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <p style="font-size:13px; color:#5a7aaa; line-height:1.6;">Organizza le spese come vuoi tu, con etichette e colori personalizzati.</p>
        </div>
